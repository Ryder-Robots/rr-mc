...
namespace rrobot {
    ...
    class MspSensor {
        ...
        void set_accAvail(int acc_avail) {
            _acc_avail = acc_avail;
        }
        ...
        void set_gyroAvail(int gyro_avail) {
            _gyro_avail = gyro_avail;
        }
        ...
        void set_magAvail(int mag_avail) {
            _mag_avail = mag_avail;
        }
